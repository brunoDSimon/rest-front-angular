(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-dashboard-dashboard-module"], {
    ...
    "/cWL":
    /*!***************************************************************************************************************!*\
      !*** ./src/app/features/dashboard/componets/sum-group-month-companies/sum-group-month-companies.component.ts ***!
      \***************************************************************************************************************/

    /*! exports provided: SumGroupMonthCompaniesComponent */
    ...
    function cWL(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SumGroupMonthCompaniesComponent", function () {
        return SumGroupMonthCompaniesComponent;
      });
      /* harmony import */
      ...
      var _service_dashboard_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../../service/dashboard.service */
      "bz71");
      /* harmony import */


      var src_app_shared_pipe_reais_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/shared/pipe/reais.pipe */
      "fqHQ");

      var SumGroupMonthCompaniesComponent = /*#__PURE__*/function () {
        function SumGroupMonthCompaniesComponent(dashboardService, reais) {
          _classCallCheck(this, SumGroupMonthCompaniesComponent);
          ...
          this.teste = [];
          this._names = [];
          this._cores = ["#3e95cd", "#4c32a8", "#DF3A01", "#0B4C5F", "#8000FF", "#CCFFE5", "#FF9999", "#CCFFCC", "#FF3333"];
        }

        _createClass(SumGroupMonthCompaniesComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.getSumGroupMonthCompanies();
          }
        }, {
          key: "getSumGroupMonthCompanies",
          value: function getSumGroupMonthCompanies() {
            var _this = this;

            this.dashboardService.sumGroupMonthCompanies().subscribe(function (res) {
              _this.response = res.data;

              _this.response.map(function (item) {
                if (_this._monthsChart.indexOf(item.periodo) == -1) {
                  _this._monthsChart.push(item.periodo);
                }
              });

              _this.response.map(function (res) {
                if (_this._conteudoChart.length) {
                  var index = _this._conteudoChart.findIndex(function (t) {
                    return t.label == res.companies.companyName;
                  });

                  if (index != -1) {
                    _this._conteudoChart[index].dataValorPeriodo.push({
                      valor: res.resultGroup,
                      periodo: res.periodo
                    });
                  } else {
                    _this._conteudoChart.push({
                      label: res.companies.companyName,
                      dataValorPeriodo: [{
                        valor: res.resultGroup,
                        periodo: res.periodo
                      }],
                      backgroundColor: _this._cores[_this._conteudoChart.length],
                      data: []
                    });
                  }
                } else {
                  _this._conteudoChart.push({
                    ...
                    backgroundColor: _this._cores[0],
                    data: []
                  });
                }
              });

              _this._conteudoChart.map(function (aux, i) {
                _this._monthsChart.map(function (periodo) {
                  var itemEncontrado = aux.dataValorPeriodo.findIndex(function (item) {
                    return item.periodo == periodo;
                  });

                  if (itemEncontrado != -1) {
                    _this._conteudoChart[i].data.push(aux.dataValorPeriodo[itemEncontrado].valor);
                  } else {
                    _this._conteudoChart[i].data.push(0);
                  }
                });

                _this._valor.push(aux.data);
              });
          ...
          value: function render() {
            ...
            new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(document.getElementById("bar-chart-grouped"), {
              type: 'bar',
              data: {
              ...
              options: {
                ...
                tooltips: {
                  ...
                  callbacks: {
                    ...
                    label: function label(t, c) {
                      var label = c.datasets[t.datasetIndex].label;

                      var valor = _this2.reais.transform(c.datasets[t.datasetIndex].data[t.index]);

                      return " ".concat(label, "  ").concat(valor, "  ");
                    },
      ...
      SumGroupMonthCompaniesComponent.ɵfac = function SumGroupMonthCompaniesComponent_Factory(t) {
        return new (t || SumGroupMonthCompaniesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_dashboard_service__WEBPACK_IMPORTED_MODULE_2__["DashboardService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_pipe_reais_pipe__WEBPACK_IMPORTED_MODULE_3__["ReaisPipe"]));
      };

      SumGroupMonthCompaniesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SumGroupMonthCompaniesComponent,
        selectors: [["app-sum-group-month-companies"]],
        decls: 3,
        vars: 0,
        consts: [[1, "row"], [1, "col-10", "offset-1"], ["id", "bar-chart-grouped", "width", "800", "height", "450"]],
        template: function SumGroupMonthCompaniesComponent_Template(rf, ctx) {
          if (rf & 1) {
        ...
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzdW0tZ3JvdXAtbW9udGgtY29tcGFuaWVzLmNvbXBvbmVudC5zY3NzIn0= */"]
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SumGroupMonthCompaniesComponent, [{
          ...
          return [{
            ...
            type: src_app_shared_pipe_reais_pipe__WEBPACK_IMPORTED_MODULE_3__["ReaisPipe"]
          }];
        }, null);
      })();
      /***/
    ...
    "60Qw":
    /*!*********************************************************************!*\
      !*** ./src/app/features/dashboard/componets/dashboard.component.ts ***!
      \*********************************************************************/

    /*! exports provided: DashboardComponent */

    /***/
    function Qw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _sum_group_month_sum_group_month_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./sum-group-month/sum-group-month.component */
      "HIKX");
      /* harmony import */


      var _sum_group_companies_sum_group_companies_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./sum-group-companies/sum-group-companies.component */
      "bpK1");
      /* harmony import */


      var _sum_group_month_companies_sum_group_month_companies_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./sum-group-month-companies/sum-group-month-companies.component */
      "/cWL");
      ...
      DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 20,
        vars: 0,
        consts: [[1, "container"], [1, "row"], [1, "col-12", "mb-3"], [1, "card"], [1, "card-body"], [1, "card-title"], [1, "col-12"]],
        template: function DashboardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "Soma total de ganhos por m\xEAs");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](7, "app-sum-group-month");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, "Lucros agrupado por empresa");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](13, "app-sum-group-companies");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](18, "Soma total de ganhos por m\xEAs agrupado por empresa");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](19, "app-sum-group-month-companies");
        ...
        directives: [_sum_group_month_sum_group_month_component__WEBPACK_IMPORTED_MODULE_1__["SumGroupMonthComponent"], _sum_group_companies_sum_group_companies_component__WEBPACK_IMPORTED_MODULE_2__["SumGroupCompaniesComponent"], _sum_group_month_companies_sum_group_month_companies_component__WEBPACK_IMPORTED_MODULE_3__["SumGroupMonthCompaniesComponent"]],
    ...
    "HIKX":
    /*!*******************************************************************************************!*\
      !*** ./src/app/features/dashboard/componets/sum-group-month/sum-group-month.component.ts ***!
      \*******************************************************************************************/

    /*! exports provided: SumGroupMonthComponent */

    /***/
    function HIKX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SumGroupMonthComponent", function () {
        return SumGroupMonthComponent;
      });
      /* harmony import */
      ...
      var src_app_shared_pipe_mes_ano_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/shared/pipe/mes-ano.pipe */
      "HdKI");
      /* harmony import */
      ...
      function SumGroupMonthComponent_tr_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](8, "reais");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](5, 3, ctx_r0.transfor(aux_r1 == null ? null : aux_r1.periodo), "MMMM"));

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](8, 6, aux_r1 == null ? null : aux_r1.resultGroup));
        }
      }

      var SumGroupMonthComponent = /*#__PURE__*/function () {
        function SumGroupMonthComponent(dashboardService, reais, mesAno, dateFormatPipe) {
          _classCallCheck(this, SumGroupMonthComponent);
        ...
        _createClass(SumGroupMonthComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.getSumGroupMonth();
          }
        }, {
          key: "getSumGroupMonth",
          value: function getSumGroupMonth() {
            var _this3 = this;

            this.dashboardService.sumGroupMonth().subscribe(function (res) {
              _this3._response = res.data.beadGroupMonth;
              res.data.beadGroupMonth.map(function (item) {
                _this3._valueTotal.push(item.resultGroup.toFixed(2));
              });
              res.data.beadGroupMonth.map(function (item) {
                _this3._month.push(item.periodo);
              });
          ...
          value: function render() {
            ...
            // console.log(meses)
            this.myChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(document.getElementById("bar-chart"), {
              type: 'bar',
              data: {
                labels: this._month,
                datasets: [{
              ...
              options: {
                ...
                tooltips: {
                  ...
                  callbacks: {
                    ...
                    label: function label(t, c) {
                      var label = c.datasets[t.datasetIndex];

                      var valor = _this4.reais.transform(c.datasets[t.datasetIndex].data[t.index]);
          ...
          key: "getMesesSigla",
          value: function getMesesSigla() {
            var _this5 = this;

            var meses = [];

            var periodo = this._month.substring(5, 7);

            var lengthPeriodo = this._month.length;

            if (lengthPeriodo) {
              periodo.map(function (mes) {
                meses.push(_this5.mesAno.transform(mes, 'sigla', true).toString());
              });
              return meses;
            }
      ...
      SumGroupMonthComponent.ɵfac = function SumGroupMonthComponent_Factory(t) {
        return new (t || SumGroupMonthComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_dashboard_service__WEBPACK_IMPORTED_MODULE_2__["DashboardService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_pipe_reais_pipe__WEBPACK_IMPORTED_MODULE_3__["ReaisPipe"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_pipe_mes_ano_pipe__WEBPACK_IMPORTED_MODULE_4__["MesAnoPipe"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_moment__WEBPACK_IMPORTED_MODULE_5__["DateFormatPipe"]));
      };

      SumGroupMonthComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SumGroupMonthComponent,
        selectors: [["app-sum-group-month"]],
        decls: 15,
        vars: 1,
        consts: [[1, "row"], [1, "col-8"], ["id", "bar-chart", "width", "200", "height", "150"], [1, "col-4"], [1, "table", "table-striped", "table-light"], ["scope", "col"], ["scope", "col text-hei"], [4, "ngFor", "ngForOf"], ["scope", "row"]],
        template: function SumGroupMonthComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Mes");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "th", 5);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, "Valor Total");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](14, SumGroupMonthComponent_tr_14_Template, 9, 8, "tr", 7);
        ...
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"], src_app_shared_pipe_reais_pipe__WEBPACK_IMPORTED_MODULE_3__["ReaisPipe"]],
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzdW0tZ3JvdXAtbW9udGguY29tcG9uZW50LnNjc3MifQ== */"]
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SumGroupMonthComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
          ...
          return [{
            ...
            type: src_app_shared_pipe_mes_ano_pipe__WEBPACK_IMPORTED_MODULE_4__["MesAnoPipe"]
          }, {
    ...
    function IAk5(module, __webpack_exports__, __webpack_require__) {
      ...
      var _componets_dashboard_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./componets/dashboard.component */
      "60Qw");
      /* harmony import */
      ...
      var src_app_shared_modules_pipe_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _componets_sum_group_month_sum_group_month_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./componets/sum-group-month/sum-group-month.component */
      "HIKX");
      /* harmony import */


      var _componets_sum_group_companies_sum_group_companies_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./componets/sum-group-companies/sum-group-companies.component */
      "bpK1");
      /* harmony import */


      var _componets_sum_group_month_companies_sum_group_month_companies_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./componets/sum-group-month-companies/sum-group-month-companies.component */
      "/cWL");
      ...
      DashboardModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"], src_app_shared_modules_pipe_module__WEBPACK_IMPORTED_MODULE_4__["PipeModule"], ngx_currency__WEBPACK_IMPORTED_MODULE_5__["NgxCurrencyModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], ngx_mask__WEBPACK_IMPORTED_MODULE_8__["NgxMaskModule"].forRoot(), src_app_shared_modules_shared_module__WEBPACK_IMPORTED_MODULE_9__["SharedModule"], ngx_custom_validators__WEBPACK_IMPORTED_MODULE_10__["CustomFormsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DashboardModule, {
          declarations: [_componets_dashboard_component__WEBPACK_IMPORTED_MODULE_2__["DashboardComponent"], _componets_sum_group_month_sum_group_month_component__WEBPACK_IMPORTED_MODULE_11__["SumGroupMonthComponent"], _componets_sum_group_companies_sum_group_companies_component__WEBPACK_IMPORTED_MODULE_12__["SumGroupCompaniesComponent"], _componets_sum_group_month_companies_sum_group_month_companies_component__WEBPACK_IMPORTED_MODULE_13__["SumGroupMonthCompaniesComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"], src_app_shared_modules_pipe_module__WEBPACK_IMPORTED_MODULE_4__["PipeModule"], ngx_currency__WEBPACK_IMPORTED_MODULE_5__["NgxCurrencyModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], ngx_mask__WEBPACK_IMPORTED_MODULE_8__["NgxMaskModule"], src_app_shared_modules_shared_module__WEBPACK_IMPORTED_MODULE_9__["SharedModule"], ngx_custom_validators__WEBPACK_IMPORTED_MODULE_10__["CustomFormsModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function UGnj(module, __webpack_exports__, __webpack_require__) {
      ...
      var _componets_sum_group_month_sum_group_month_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./componets/sum-group-month/sum-group-month.component */
      "HIKX");

      var routes = [{
        path: '',
        component: _componets_dashboard_component__WEBPACK_IMPORTED_MODULE_2__["DashboardComponent"]
      }, {
        path: 'soma-agrupada-mes',
        component: _componets_sum_group_month_sum_group_month_component__WEBPACK_IMPORTED_MODULE_3__["SumGroupMonthComponent"]
      }];
    ...
    "bpK1":
    /*!***************************************************************************************************!*\
      !*** ./src/app/features/dashboard/componets/sum-group-companies/sum-group-companies.component.ts ***!
      \***************************************************************************************************/

    /*! exports provided: SumGroupCompaniesComponent */

    /***/
    function bpK1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SumGroupCompaniesComponent", function () {
        return SumGroupCompaniesComponent;
      });
      /* harmony import */
      ...
      function SumGroupCompaniesComponent_tr_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](7, "reais");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](aux_r1 == null ? null : aux_r1.companies == null ? null : aux_r1.companies.companyName);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](7, 3, aux_r1 == null ? null : aux_r1.resultGroup));
        }
      }

      var SumGroupCompaniesComponent = /*#__PURE__*/function () {
        function SumGroupCompaniesComponent(dashboardService, reais) {
          _classCallCheck(this, SumGroupCompaniesComponent);
        ...
        _createClass(SumGroupCompaniesComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.getSumTotalGroupCompanies();
          }
        }, {
          key: "getSumTotalGroupCompanies",
          value: function getSumTotalGroupCompanies() {
            var _this6 = this;

            this.dashboardService.sumTotalGroupCompanies().subscribe(function (res) {
              // console.log(res.data.beadSumGroup, 'getSumTotalGroupCompanies');
              _this6._response = res.data.beadSumGroup;
              res.data.beadSumGroup.map(function (item) {
                _this6._valueTotal.push(item.resultGroup.toFixed(2));
              });
              res.data.beadSumGroup.map(function (item) {
                _this6._namesCompanies.push(item.companies.companyName);
          ...
          value: function render() {
            ...
            this.myChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(document.getElementById("pie-chart"), {
              type: 'pie',
              data: {
                ...
                tooltips: {
                  ...
                  callbacks: {
                    ...
                    label: function label(t, c) {
                      ...
                      var valor = _this7.reais.transform(c.datasets[t.datasetIndex].data[t.index]);
      ...
      SumGroupCompaniesComponent.ɵfac = function SumGroupCompaniesComponent_Factory(t) {
        return new (t || SumGroupCompaniesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_dashboard_service__WEBPACK_IMPORTED_MODULE_2__["DashboardService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_pipe_reais_pipe__WEBPACK_IMPORTED_MODULE_3__["ReaisPipe"]));
      };

      SumGroupCompaniesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SumGroupCompaniesComponent,
        selectors: [["app-sum-group-companies"]],
        decls: 15,
        vars: 1,
        consts: [[1, "row"], [1, "col-8"], ["id", "pie-chart", "width", "800", "height", "450"], [1, "col-4"], [1, "table", "table-striped", "table-light"], ["scope", "col"], ["scope", "col text-hei"], [4, "ngFor", "ngForOf"], ["scope", "row"]],
        template: function SumGroupCompaniesComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Compania");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](14, SumGroupCompaniesComponent_tr_14_Template, 8, 5, "tr", 7);
        ...
        pipes: [src_app_shared_pipe_reais_pipe__WEBPACK_IMPORTED_MODULE_3__["ReaisPipe"]],
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzdW0tZ3JvdXAtY29tcGFuaWVzLmNvbXBvbmVudC5zY3NzIn0= */"]
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SumGroupCompaniesComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    "bz71":
    /*!*****************************************************************!*\
      !*** ./src/app/features/dashboard/service/dashboard.service.ts ***!
      \*****************************************************************/

    /*! exports provided: DashboardService */

    /***/
    function bz71(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var DashboardService = /*#__PURE__*/function (_src_app_shared_servi) {
        _inherits(DashboardService, _src_app_shared_servi);

        var _super = _createSuper(DashboardService);

        function DashboardService(http, dateFormatPipe) {
          var _this8;
          ...
          _this8.http = http;
          _this8.dateFormatPipe = dateFormatPipe;
          return _this8;
        }

        _createClass(DashboardService, [{
          key: "sumGroupMonthCompanies",
          value: function sumGroupMonthCompanies() {
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + "bead/sumGroupMonthCompanies").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
              return res;
          ...
          key: "sumGroupMonth",
          value: function sumGroupMonth() {
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + "bead/sumGroupMonth").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
              return res;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (error) {
          ...
          key: "sumTotalGroupCompanies",
          value: function sumTotalGroupCompanies() {
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + "bead/sumTotalGroupCompanies").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
              return res;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (error) {
      ...
      DashboardService.ɵfac = function DashboardService_Factory(t) {
        return new (t || DashboardService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_moment__WEBPACK_IMPORTED_MODULE_5__["DateFormatPipe"]));
      };
